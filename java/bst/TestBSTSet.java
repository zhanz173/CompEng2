...
public class TestBSTSet {
	...
	public static void Runtime() throws FileNotFoundException, UnsupportedEncodingException{
		Random rd = new Random();  
	    long startTime, endTime;
		double runTime=0.0; 
		
		PrintWriter writer = new PrintWriter("Constructor_runtime.txt", "UTF-8");
		
		for(int j = 0; j < 50000; j += 10) {
			int[] d1 = new int[j];
			...
			runTime =(double) (endTime - startTime)/5.0;
			writer.println(j + " " + runTime);
